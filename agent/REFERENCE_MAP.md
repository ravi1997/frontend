...
| `WORKFLOW:GO_LOOP`           | [`workflows/go_dev_loop.md`](workflows/go_dev_loop.md)                     | Go development       |
| `WORKFLOW:RUST_LOOP`         | [`workflows/rust_dev_loop.md`](workflows/rust_dev_loop.md)                 | Rust development     |
