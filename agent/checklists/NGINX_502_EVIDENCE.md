...
### Commands to Run (Nginx Configuration)
...
### Expected Information (Nginx Configuration)
...
### Expected Information (Error Logs)
...
### Expected Information (Upstream Service Health)
...
### Red Flags (Upstream Service Health)
...
### Expected Information (Application Server Details)
...
### Red Flags (Application Server Details)
...
### Commands to Run (Network Connectivity)
...
### Expected Information (Network Connectivity)

- [ ] Can connect to upstream directly
- [ ] Port is listening
- [ ] No firewall blocking

### Red Flags (Network Connectivity)
