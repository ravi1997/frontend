...
### Commands to Run (Baseline Metrics)
...
### Expected Information (Baseline Metrics)
...
### Commands to Run (Application Metrics)
...
### Expected Information (Application Metrics)
...
### Commands to Run (Database Performance)
...
### Expected Information (Database Performance)
...
### Red Flags (Database Performance)
...
### Commands to Run (Application Profiling)
...
### Expected Information (Application Profiling)
...
### Red Flags (Application Profiling)
...
### Commands to Run (Network and I/O)
...
### Expected Information (Network and I/O)
...
### Expected Information (Code Analysis)
