...
@JsonKey(readValue: IdReader.readIdCallback) String get id; String? get variableName; Object? get label;@JsonKey(name: 'field_type') QuestionType get type; Object? get helperText; Object? get placeholder; Object? get defaultValue; bool get isRequired; List<FormQuestionOption>? get options; bool get isReadOnly; bool get isHidden; String? get validationRegex; int? get minLength; int? get maxLength; num? get minValue; num? get maxValue; String? get inputMask; String? get customErrorMessage;// Advanced Validation
...
class _FormQuestion extends FormQuestion {
  const _FormQuestion({@JsonKey(readValue: IdReader.readIdCallback) required this.id, this.variableName, required this.label, @JsonKey(name: 'field_type') required this.type, this.helperText, this.placeholder, this.defaultValue, this.isRequired = false, final  List<FormQuestionOption>? options, this.isReadOnly = false, this.isHidden = false, this.validationRegex, this.minLength, this.maxLength, this.minValue, this.maxValue, this.inputMask, this.customErrorMessage, this.dateMin, this.dateMax, final  List<String>? allowedFileTypes, this.maxFileSize, this.maxFiles, this.isUnique, this.requiresConfirmation, this.minSelection, this.maxSelection, this.minWordCount, this.maxWordCount, this.disablePastDates, this.disableFutureDates, this.disableWeekends, final  Map<String, dynamic>? conditionalLogic, final  Map<String, dynamic>? actionConfig, @JsonKey(name: 'metadata') final  Map<String, dynamic>? metadata, this.style = const QuestionStyle()}): _options = options,_allowedFileTypes = allowedFileTypes,_conditionalLogic = conditionalLogic,_actionConfig = actionConfig,_metadata = metadata,super._();
