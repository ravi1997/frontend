...
@JsonKey(readValue: IdReader.readIdCallback) String get id;@JsonKey(name: 'variable_name') String? get variableName; Object? get label;@JsonKey(name: 'field_type', fromJson: _questionTypeFromJson) QuestionType get type;@JsonKey(name: 'help_text') Object? get helperText;@JsonKey(includeToJson: false) Object? get placeholder;@JsonKey(name: 'default_value') Object? get defaultValue;@JsonKey(name: 'validation', includeToJson: false) Map<String, dynamic>? get validation;@JsonKey(name: 'is_required', includeToJson: false) bool get isRequired; List<FormQuestionOption>? get options;@JsonKey(name: 'is_read_only') bool get isReadOnly;@JsonKey(name: 'is_hidden') bool get isHidden;@JsonKey(name: 'is_repeatable') bool get isRepeatable;@JsonKey(name: 'repeat_min') int? get repeatMin;@JsonKey(name: 'repeat_max') int? get repeatMax;@JsonKey(name: 'keep_last_value') bool get keepLastValue;@JsonKey(includeToJson: false) String? get validationRegex;@JsonKey(includeToJson: false) int? get minLength;@JsonKey(includeToJson: false) int? get maxLength;@JsonKey(includeToJson: false) num? get minValue;@JsonKey(includeToJson: false) num? get maxValue;@JsonKey(includeToJson: false) String? get inputMask;@JsonKey(includeToJson: false) String? get customErrorMessage;// Advanced Validation
...
switch (_that) {
case _FormQuestion() when $default != null:
return $default(_that.id,_that.variableName,_that.label,_that.type,_that.helperText,_that.placeholder,_that.defaultValue,_that.validation,_that.isRequired,_that.options,_that.isReadOnly,_that.isHidden,_that.isRepeatable,_that.repeatMin,_that.repeatMax,_that.keepLastValue,_that.validationRegex,_that.minLength,_that.maxLength,_that.minValue,_that.maxValue,_that.inputMask,_that.customErrorMessage,_that.dateMin,_that.dateMax,_that.allowedFileTypes,_that.maxFileSize,_that.maxFiles,_that.isUnique,_that.requiresConfirmation,_that.minSelection,_that.maxSelection,_that.minWordCount,_that.maxWordCount,_that.disablePastDates,_that.disableFutureDates,_that.disableWeekends,_that.conditionalLogic,_that.actionConfig,_that.metadata,_that.style);case _:
  return orElse();
...
class _FormQuestion extends FormQuestion {
  const _FormQuestion({@JsonKey(readValue: IdReader.readIdCallback) required this.id, @JsonKey(name: 'variable_name') this.variableName, required this.label, @JsonKey(name: 'field_type', fromJson: _questionTypeFromJson) required this.type, @JsonKey(name: 'help_text') this.helperText, @JsonKey(includeToJson: false) this.placeholder, @JsonKey(name: 'default_value') this.defaultValue, @JsonKey(name: 'validation', includeToJson: false) final  Map<String, dynamic>? validation, @JsonKey(name: 'is_required', includeToJson: false) this.isRequired = false, final  List<FormQuestionOption>? options, @JsonKey(name: 'is_read_only') this.isReadOnly = false, @JsonKey(name: 'is_hidden') this.isHidden = false, @JsonKey(name: 'is_repeatable') this.isRepeatable = false, @JsonKey(name: 'repeat_min') this.repeatMin, @JsonKey(name: 'repeat_max') this.repeatMax, @JsonKey(name: 'keep_last_value') this.keepLastValue = false, @JsonKey(includeToJson: false) this.validationRegex, @JsonKey(includeToJson: false) this.minLength, @JsonKey(includeToJson: false) this.maxLength, @JsonKey(includeToJson: false) this.minValue, @JsonKey(includeToJson: false) this.maxValue, @JsonKey(includeToJson: false) this.inputMask, @JsonKey(includeToJson: false) this.customErrorMessage, @JsonKey(includeToJson: false) this.dateMin, @JsonKey(includeToJson: false) this.dateMax, @JsonKey(includeToJson: false) final  List<String>? allowedFileTypes, @JsonKey(includeToJson: false) this.maxFileSize, @JsonKey(includeToJson: false) this.maxFiles, @JsonKey(includeToJson: false) this.isUnique, @JsonKey(includeToJson: false) this.requiresConfirmation, @JsonKey(includeToJson: false) this.minSelection, @JsonKey(includeToJson: false) this.maxSelection, @JsonKey(includeToJson: false) this.minWordCount, @JsonKey(includeToJson: false) this.maxWordCount, @JsonKey(includeToJson: false) this.disablePastDates, @JsonKey(includeToJson: false) this.disableFutureDates, @JsonKey(includeToJson: false) this.disableWeekends, @JsonKey(name: 'conditional_logic', includeToJson: false) final  Map<String, dynamic>? conditionalLogic, @JsonKey(name: 'action_config', includeToJson: false) final  Map<String, dynamic>? actionConfig, @JsonKey(name: 'meta_data') final  Map<String, dynamic>? metadata, @JsonKey(includeToJson: false) this.style = const QuestionStyle()}): _validation = validation,_options = options,_allowedFileTypes = allowedFileTypes,_conditionalLogic = conditionalLogic,_actionConfig = actionConfig,_metadata = metadata,super._();
...
@override@JsonKey(name: 'field_type', fromJson: _questionTypeFromJson) final  QuestionType type;
