...
mixin _$FormBuilderState {
 ...
 BuilderForm get form; String? get selectedSectionId; String? get selectedQuestionId; bool get isFormSelected; bool get isSaving; bool get isLoading; String get editingLocale; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,form,selectedSectionId,selectedQuestionId,isFormSelected,isSaving,isLoading,editingLocale,error);

@override
String toString() {
  return 'FormBuilderState(form: $form, selectedSectionId: $selectedSectionId, selectedQuestionId: $selectedQuestionId, isFormSelected: $isFormSelected, isSaving: $isSaving, isLoading: $isLoading, editingLocale: $editingLocale, error: $error)';
}
...
@useResult
$Res call({
 BuilderForm form, String? selectedSectionId, String? selectedQuestionId, bool isFormSelected, bool isSaving, bool isLoading, String editingLocale, String? error
});
...
/// Create a copy of FormBuilderState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? form = null,Object? selectedSectionId = freezed,Object? selectedQuestionId = freezed,Object? isFormSelected = null,Object? isSaving = null,Object? isLoading = null,Object? editingLocale = null,Object? error = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( BuilderForm form,  String? selectedSectionId,  String? selectedQuestionId,  bool isFormSelected,  bool isSaving,  bool isLoading,  String editingLocale,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FormBuilderState() when $default != null:
return $default(_that.form,_that.selectedSectionId,_that.selectedQuestionId,_that.isFormSelected,_that.isSaving,_that.isLoading,_that.editingLocale,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BuilderForm form,  String? selectedSectionId,  String? selectedQuestionId,  bool isFormSelected,  bool isSaving,  bool isLoading,  String editingLocale,  String? error)  $default,) {final _that = this;
switch (_that) {
case _FormBuilderState():
return $default(_that.form,_that.selectedSectionId,_that.selectedQuestionId,_that.isFormSelected,_that.isSaving,_that.isLoading,_that.editingLocale,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( BuilderForm form,  String? selectedSectionId,  String? selectedQuestionId,  bool isFormSelected,  bool isSaving,  bool isLoading,  String editingLocale,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _FormBuilderState() when $default != null:
return $default(_that.form,_that.selectedSectionId,_that.selectedQuestionId,_that.isFormSelected,_that.isSaving,_that.isLoading,_that.editingLocale,_that.error);case _:
  return null;
...
class _FormBuilderState implements FormBuilderState {
  const _FormBuilderState({required this.form, this.selectedSectionId, this.selectedQuestionId, this.isFormSelected = false, this.isSaving = false, this.isLoading = false, this.editingLocale = 'en', this.error});
...
/// Create a copy of FormBuilderState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? form = null,Object? selectedSectionId = freezed,Object? selectedQuestionId = freezed,Object? isFormSelected = null,Object? isSaving = null,Object? isLoading = null,Object? editingLocale = null,Object? error = freezed,}) {
