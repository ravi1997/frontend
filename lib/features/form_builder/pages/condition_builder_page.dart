...
import 'package:frontend/features/form_builder/services/condition_controller.dart';
...
class _ConditionBuilderPageState extends ConsumerState<ConditionBuilderPage> {
  ...
  Future<void> _loadRules() async {
    ...
    try {
      await ref.read(conditionControllerProvider).loadRules(widget.formId);
    } catch (e) {
  ...
  Future<void> _createRule() async {
    ...
    try {
      ...
      await ref.read(conditionControllerProvider).createRule(
  ...
  Future<void> _deleteRule(String ruleId) async {
    try {
      await ref.read(conditionControllerProvider).deleteRule(ruleId);
  ...
  Future<void> _toggleRule(String ruleId) async {
    try {
      await ref.read(conditionControllerProvider).toggleRule(ruleId);
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    final rules = ref.watch(conditionControllerProvider).state;
