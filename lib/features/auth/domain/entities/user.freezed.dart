...
mixin _$User {
 ...
 String get id; String get username; String get email; List<String> get roles;@JsonKey(name: 'user_type') String get userType;@JsonKey(name: 'employee_id') String? get employeeId; String? get mobile;
...
@useResult
$Res call({
 String id, String username, String email, List<String> roles,@JsonKey(name: 'user_type') String userType,@JsonKey(name: 'employee_id') String? employeeId, String? mobile
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String username,  String email,  List<String> roles, @JsonKey(name: 'user_type')  String userType, @JsonKey(name: 'employee_id')  String? employeeId,  String? mobile)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _User() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String username,  String email,  List<String> roles, @JsonKey(name: 'user_type')  String userType, @JsonKey(name: 'employee_id')  String? employeeId,  String? mobile)  $default,) {final _that = this;
switch (_that) {
case _User():
return $default(_that.id,_that.username,_that.email,_that.roles,_that.userType,_that.employeeId,_that.mobile);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String username,  String email,  List<String> roles, @JsonKey(name: 'user_type')  String userType, @JsonKey(name: 'employee_id')  String? employeeId,  String? mobile)?  $default,) {final _that = this;
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.username,_that.email,_that.roles,_that.userType,_that.employeeId,_that.mobile);case _:
  return null;
...
class _User extends User {
  const _User({required this.id, required this.username, required this.email, final  List<String> roles = const [], @JsonKey(name: 'user_type') required this.userType, @JsonKey(name: 'employee_id') this.employeeId, this.mobile}): _roles = roles,super._();
