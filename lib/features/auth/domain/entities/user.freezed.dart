...
mixin _$User {
 ...
 String get id; String get username; String get email; List<String> get roles;@JsonKey(name: 'user_type') String? get userType;@JsonKey(name: 'employee_id') String? get employeeId;@JsonKey(name: 'mobile') String? get mobile; String? get department;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'organization_id') String? get organizationId;// Extra fields returned by the admin detail endpoint
@JsonKey(name: 'is_admin') bool get isAdminFlag;@JsonKey(name: 'is_deleted') bool get isDeleted;@JsonKey(name: 'is_email_verified') bool get isEmailVerified;@JsonKey(name: 'failed_login_attempts') int get failedLoginAttempts;@JsonKey(name: 'otp_resend_count') int get otpResendCount;@JsonKey(name: 'lock_until') String? get lockUntil;@JsonKey(name: 'last_login') String? get lastLogin;@JsonKey(name: 'created_at') String? get createdAt;@JsonKey(name: 'updated_at') String? get updatedAt;@JsonKey(name: 'deleted_at') String? get deletedAt;@JsonKey(name: 'password_expiration') String? get passwordExpiration;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,username,email,const DeepCollectionEquality().hash(roles),userType,employeeId,mobile,department,isActive,organizationId,isAdminFlag,isDeleted,isEmailVerified,failedLoginAttempts,otpResendCount,lockUntil,lastLogin,createdAt,updatedAt,deletedAt,passwordExpiration]);

@override
String toString() {
  return 'User(id: $id, username: $username, email: $email, roles: $roles, userType: $userType, employeeId: $employeeId, mobile: $mobile, department: $department, isActive: $isActive, organizationId: $organizationId, isAdminFlag: $isAdminFlag, isDeleted: $isDeleted, isEmailVerified: $isEmailVerified, failedLoginAttempts: $failedLoginAttempts, otpResendCount: $otpResendCount, lockUntil: $lockUntil, lastLogin: $lastLogin, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, passwordExpiration: $passwordExpiration)';
}
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? username = null,Object? email = null,Object? roles = null,Object? userType = freezed,Object? employeeId = freezed,Object? mobile = freezed,Object? department = freezed,Object? isActive = null,Object? organizationId = freezed,Object? isAdminFlag = null,Object? isDeleted = null,Object? isEmailVerified = null,Object? failedLoginAttempts = null,Object? otpResendCount = null,Object? lockUntil = freezed,Object? lastLogin = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? deletedAt = freezed,Object? passwordExpiration = freezed,}) {
...
switch (_that) {
case _User() when $default != null:
return $default(_that.id,_that.username,_that.email,_that.roles,_that.userType,_that.employeeId,_that.mobile,_that.department,_that.isActive,_that.organizationId,_that.isAdminFlag,_that.isDeleted,_that.isEmailVerified,_that.failedLoginAttempts,_that.otpResendCount,_that.lockUntil,_that.lastLogin,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.passwordExpiration);case _:
  return orElse();
...
class _User extends User {
  const _User({required this.id, required this.username, required this.email, final  List<String> roles = const [], @JsonKey(name: 'user_type') this.userType, @JsonKey(name: 'employee_id') this.employeeId, @JsonKey(name: 'mobile') this.mobile, this.department, @JsonKey(name: 'is_active') this.isActive = true, @JsonKey(name: 'organization_id') this.organizationId, @JsonKey(name: 'is_admin') this.isAdminFlag = false, @JsonKey(name: 'is_deleted') this.isDeleted = false, @JsonKey(name: 'is_email_verified') this.isEmailVerified = false, @JsonKey(name: 'failed_login_attempts') this.failedLoginAttempts = 0, @JsonKey(name: 'otp_resend_count') this.otpResendCount = 0, @JsonKey(name: 'lock_until') this.lockUntil, @JsonKey(name: 'last_login') this.lastLogin, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(name: 'deleted_at') this.deletedAt, @JsonKey(name: 'password_expiration') this.passwordExpiration}): _roles = roles,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,username,email,const DeepCollectionEquality().hash(_roles),userType,employeeId,mobile,department,isActive,organizationId,isAdminFlag,isDeleted,isEmailVerified,failedLoginAttempts,otpResendCount,lockUntil,lastLogin,createdAt,updatedAt,deletedAt,passwordExpiration]);
