...
class UserSchema {
  ...
  final List<UserSchemaRolesEnum>? roles;
  ...
  final UserSchemaUserTypeEnum userType;
...
const UserSchemaRolesEnum(this.value);
...
enum UserSchemaUserTypeEnum {
@JsonValue(r'employee')
employee(r'employee'),
@JsonValue(r'general')
general(r'general');

const UserSchemaUserTypeEnum(this.value);
