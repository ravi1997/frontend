...
class SectionHooksApi {

  final Dio _dio;

  const SectionHooksApi(this._dio);
  ...
  Future<Response<void>> formApiV1FormsFormIdSectionsSectionIdHooksTriggerPost({ 
    ...
    final _path = r'/form/api/v1/forms/{form_id}/sections/{section_id}/hooks/trigger'.replaceAll('{' r'form_id' '}', formId.toString()).replaceAll('{' r'section_id' '}', sectionId.toString());
