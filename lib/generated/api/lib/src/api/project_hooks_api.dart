...
class ProjectHooksApi {

  final Dio _dio;

  const ProjectHooksApi(this._dio);
  ...
  Future<Response<void>> formApiV1FormsHooksTriggerPost({ 
    ...
    final _path = r'/form/api/v1/forms/hooks/trigger'.replaceAll('{' r'project_id' '}', projectId.toString());
