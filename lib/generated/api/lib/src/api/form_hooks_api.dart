...
class FormHooksApi {
  ...
  Future<Response<void>> formApiV1FormsExternalHooksHookIdApprovePost({ 
    required String hookId,
    FormApiV1FormsExternalHooksHookIdApprovePostRequest? body,
    ...
    final _path = r'/form/api/v1/forms/external-hooks/{hook_id}/approve'.replaceAll('{' r'hook_id' '}', hookId.toString());
...
_bodyData=jsonEncode(body);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> formApiV1FormsExternalHooksRegisterPost({ 
    FormApiV1FormsExternalHooksRegisterPostRequest? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/form/api/v1/forms/external-hooks/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_bodyData=jsonEncode(body);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> formApiV1FormsFormIdHooksTriggerPost({ 
    ...
    final _path = r'/form/api/v1/forms/{form_id}/hooks/trigger'.replaceAll('{' r'form_id' '}', formId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
...
_bodyData=jsonEncode(body);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> formApiV1FormsFormIdQuestionsQuestionIdHooksTriggerPost({ 
    required String formId,
    ...
    final _path = r'/form/api/v1/forms/{form_id}/questions/{question_id}/hooks/trigger'.replaceAll('{' r'form_id' '}', formId.toString()).replaceAll('{' r'question_id' '}', questionId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
