...
import 'package:ridp_api/src/model/analysis_board_create_schema.dart';
import 'package:ridp_api/src/model/analysis_board_update_schema.dart';

class AnalysisBoardApi {

  final Dio _dio;

  const AnalysisBoardApi(this._dio);
