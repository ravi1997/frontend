...
void main() {
  ...
  group(DashboardApi, () {
    ...
    //
    //Future formApiV1DashboardsDashboardIdPut(String dashboardId, { DashboardUpdateSchema body }) async
    ...
    //
    //Future formApiV1DashboardsPost({ DashboardCreateSchema body }) async
